# 👋 Hi, I'm Oscar Luciani

## Full Stack Developer

**Building production-ready business platforms with Next.js, Node.js and TypeScript.**

I build scalable web platforms and custom business applications focused on maintainability, clean architecture and long-term evolution.

From secure authentication systems and admin dashboards to digital catalogs and business operations, I develop software designed to solve real business problems.

I'm passionate about creating applications that combine technical quality, user experience and practical value.
...
- User Management
- Internal Email Invitation Workflow
- Media Management
...
- User Authentication
- Persistent Sessions (HTTP-only Cookies)
...
Worked alongside backend developers, UX/UI designers and QA engineers following an agile workflow with weekly sprints, code reviews and collaborative development.
...
Rather than focusing only on writing code, I aim to build platforms that are:
...
My goal is to deliver software that businesses can confidently adopt and continue evolving over time.
